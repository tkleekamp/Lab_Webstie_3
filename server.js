...
app.get('/player_info/', function(req, res) {
	var queryData = 'SELECT id, name FROM football_players';
	db.any(queryData)
  .then(function (rows) {
...
app.get('/player_info/select_player', function(req, res) {
	...
	var query2 = 'SELECT * FROM football_players WHERE id=' + p_choice + ';';
	var query3 = 'SELECT COUNT(*) FROM football_games INNER JOIN football_players ON football_players.id = ANY (football_games.players) WHERE football_players.id = ' + p_choice + ';';
	db.task('get-everything', task => {
	    return task.batch([
	        task.any(query1),
	        task.any(query2),
